...
- Employ Vibrant Gradient 1 (`linear-gradient(96.44deg, rgb(214, 254, 81) 6.12%, rgb(88, 81, 11) 110.28%)`) for interactive elements and active states, with `#d6fe51` for solid accent text/borders.
...
### Don't
- Do not use chromatic colors other than Vibrant Gradient 1 (`#d6fe51` / `linear-gradient(96.44deg, rgb(214, 254, 81) 6.12%, rgb(88, 81, 11) 110.28%)`) or Solar Flare (#ffa16c) for branding or interactive elements.
...
- Accent: #d6fe51 / Vibrant Gradient 1
